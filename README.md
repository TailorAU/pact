...
| Version | Status | Docs |
|---------|--------|------|
| v2.1 | **DRAFT** — adds §25, the consensus / authorization / legal-execution safety boundary ([#41](https://github.com/TailorAU/pact/issues/41)). Not released, not tagged. | [Specification](spec/v2.1/SPECIFICATION.md) · [What's in it](spec/v2.1/README.md) · [Boundary vectors](spec/v2.1/conformance/extended/execution-boundary/) |
