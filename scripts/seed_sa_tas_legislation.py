...
SA_TAS_ACTS = [
    ...
    },
    {
        ...
        "jurisdiction": "SA",
        "type": "regulation",
        "title": "Mining Regulations 2020 (SA)",
        "shortTitle": "Mining Regulations 2020",
        "year": 2020,
        "number": "Regulation No. 300 of 2020",
        "inForceDate": "2021-01-01",
        "lastAmendedDate": "2024-01-01",
        "administeredBy": "Department for Energy and Mining South Australia",
        "legislationUrl": "https://www.legislation.sa.gov.au/lz?path=%2FC%2FR%2FMining+Regulations+2020",
        "relatedDocs": ["sa/act-1971-109"],
        "sections": [
            {
                "sectionId": "r 46",
                "title": "Mining proposal - environmental outcomes",
                "content": "A mining proposal must include expected environmental outcomes and describe anticipated impacts after proposed management measures have been applied.",
                "depth": 2,
                "order": 0,
                "parentSection": "Part 5 - Mining proposals",
                "status": "in_force",
                "crossReferences": ["Mining Act 1971 s 34", "r 63"],
            },
            {
                "sectionId": "r 63",
                "title": "PEPR - outcome criteria and measurement",
                "content": "A program for environment protection and rehabilitation must set out strategies to achieve environmental outcomes and criteria for measuring environmental and completion outcomes, including what is measured, where it is measured, monitoring frequency, and relevant control or background data.",
                "depth": 2,
                "order": 1,
                "parentSection": "Part 7 - Programs for environment protection and rehabilitation",
                "status": "in_force",
                "crossReferences": ["Mining Act 1971 s 70A", "r 46", "r 66"],
            },
            {
                "sectionId": "r 66",
                "title": "Review of program",
                "content": "A tenement holder directed to review a program for environment protection and rehabilitation must complete the review and give the revised program to the Minister within the required period, subject to any approved extension.",
                "depth": 2,
                "order": 2,
                "parentSection": "Part 7 - Programs for environment protection and rehabilitation",
                "status": "in_force",
                "crossReferences": ["Mining Act 1971 s 70A", "r 63"],
            },
        ],
    },
    # ---------------------------------------------------------------------
    ...
    },
    {
        ...
        "jurisdiction": "TAS",
        "type": "regulation",
        "title": "Mineral Resources Regulations 2016 (Tas)",
        "shortTitle": "Mineral Resources Regulations 2016",
        "year": 2016,
        "number": "S.R. 2016, No. 41",
        "inForceDate": "2016-06-28",
        "lastAmendedDate": "2025-01-14",
        "administeredBy": "Mineral Resources Tasmania",
        "legislationUrl": "https://www.legislation.tas.gov.au/view/whole/html/asmade/sr-2016-041",
        "relatedDocs": ["tas/act-1995-116"],
        "sections": [
            {
                "sectionId": "r 9",
                "title": "Calculation of yearly profit",
                "content": "The regulations prescribe how yearly profit is calculated for royalty purposes, including allowable revenue and expense components connected to mining operations.",
                "depth": 2,
                "order": 0,
                "parentSection": "Part 3 - Royalties",
                "status": "in_force",
                "crossReferences": ["Mineral Resources Development Act 1995"],
            },
            {
                "sectionId": "r 15",
                "title": "Records",
                "content": "A mineral tenement holder must keep records relevant to minerals obtained, mineral products produced or sold, amounts received, and calculations used to determine yearly profit.",
                "depth": 2,
                "order": 1,
                "parentSection": "Part 4 - Records and audit",
                "status": "in_force",
                "crossReferences": ["r 9", "r 16"],
            },
            {
                "sectionId": "r 16",
                "title": "Audit report",
                "content": "Where required, a mineral tenement holder must provide audit material or financial statements supporting the income statement and royalty/profit calculations for mining operations.",
                "depth": 2,
                "order": 2,
                "parentSection": "Part 4 - Records and audit",
                "status": "in_force",
                "crossReferences": ["r 9", "r 15"],
            },
            {
                "sectionId": "Schedule 1",
                "title": "Specified minerals and royalty treatment",
                "content": "The schedules support the royalty framework by identifying specified minerals and related calculation settings relevant to mineral production and reporting.",
                "depth": 3,
                "order": 3,
                "parentSection": "Schedules",
                "status": "in_force",
                "crossReferences": ["r 9"],
            },
        ],
