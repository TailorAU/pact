...
Vectors for the v2.1 safety boundary between a **PACT protocol state**, a
...
FAIL — correctly. They encode required v2.1 behaviour that does not exist yet;
...
v2.1 job is deliberately left to the maintainer alongside the reference-server
work — see the PR for #41.

## Running them locally

```bash
cd spec/v2.1/conformance/runner
