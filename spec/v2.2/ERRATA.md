...
>
> **Fix location:** [`../v2.1/SPECIFICATION.md` §25](../v2.1/SPECIFICATION.md)
...
The normative fix is [`../v2.1/`](../v2.1/): §25 (the safety boundary and the
...
[`../v2.1/resource-types.yaml`](../v2.1/resource-types.yaml), and the
`extended/execution-boundary/` conformance vectors.

**v2.2 itself is unchanged and remains citable.** An implementation that
follows the six points above is behaving as v2.1 requires while remaining a
